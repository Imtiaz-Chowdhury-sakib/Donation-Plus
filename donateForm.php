...
<nav class="navbar navbar-expand-lg sticky-top" id="navbar" style="position: absolute; margin-top: 55px; width: 100%">
    ...
    <div class="ml-auto p2">
        <form class="form-inline my-2 my-lg-0" action="./loggedInSearch.php">
...
<section>
    ...
    <form class="donate-box" method="post" action="./donate.php">
        <input name="post_id" value="<?php echo $p_id ?>" type="hidden">
        <input name="user_id" value="<?php echo $u_id ?>" type="hidden">
        ...
        <input class="form-control form-control-lg input-box" placeholder="Enter Amount to Donate"
               name="collect_amount" type="number" min="1">
        <div class="btn-background">

            <button class="btn btn-outline-success btn-lg" style="width: 100%" type="submit"
                    name="donate" <?php if ($row['asking_amount'] <= $row['collecting_amount']) echo "disabled" ?> >
                DONATE
            </button>
