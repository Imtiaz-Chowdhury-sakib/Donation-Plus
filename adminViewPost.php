...
<div style="display:flex; flex-direction: column; margin-left: 270px; padding: 30px; font-family: 'Kumbh Sans', sans-serif">
    <h1 class="mb-3" style="text-align: center;color: #777676">View Post</h1>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    $qry = "SELECT user.name, post.category,post.title,post.details,post.date,post.asking_amount,post.collecting_amount
