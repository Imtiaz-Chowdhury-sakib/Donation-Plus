...
<head>
    <meta charset="UTF-8">
    <title>DonationPlus | Donate</title>
...
<nav class="navbar navbar-expand-lg sticky-top" id="navbar" style="position: absolute; margin-top: 55px; width: 100%">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
                ...
                <div aria-labelledby="navbarDropdown" class="dropdown-menu">
                    <a class="dropdown-item" href="./category/medical_index.php">
                    ...
                    <a class="dropdown-item" href="./category/education_index.php">
                        <div class="dropdown-icon-text">
                    ...
                    <a class="dropdown-item" href="./category/animal_index.php">
                        <div class="dropdown-icon-text">
                    ...
                    <a class="dropdown-item" href="./category/others_index.php">
                        <div class="dropdown-icon-text">
    ...
    <div class="ml-auto p2">
        <form class="form-inline my-2 my-lg-0" method="get" action="search.php">
            <input aria-label="Search" class="form-control" placeholder="Search By Title" type="search">
            <button class="btn btn btn-secondary" type="submit"  name="submit">
...
<section>
    <div class="story-box">
        <div>
            <img class="card-img-top" alt="Card image cap" height="80%" src="../image/<?php echo $row['p_id'].'.'.$row['image'] ?>" style="border-radius: 10px">
        </div>

        <div class="story-content">
            <h1><?php echo $row['title']; ?></h1>
            <h3 style="font-weight: 200"> by <?php echo $row['name']; ?></h3>
    ...
    <form class="donate-box" method="" action="./signIn.php">

        <input name="previous_amount" value="<?php echo $row['collecting_amount'] ?>" type="hidden">
        <h5>$<?php echo $row['collecting_amount']; ?> raised of goal $<?php echo $row['asking_amount']; ?> amount</h5>
        <?php
        include('dbConnection/dbconn.php');
        $p_id = $_GET['p_id'];
        $qry = "SELECT p_id,COUNT(transaction.donate_id) FROM transaction join post on(post.p_id = transaction .donate_id) WHERE p_id ='$p_id'";
        $result=mysqli_query($conn,$qry);
        ...
        <input class="form-control form-control-lg input-box" placeholder="Enter Amount to Donate" type="number"
               name="collect_amount">
        <div class="btn-background">

            <button class="btn btn-outline-success btn-lg" style="width: 100%" type="submit" name="donate"  <?php if($row['asking_amount'] <= $row['collecting_amount']) echo "disabled"?>>
                DONATE
    ...
    <div class="footer-content">
        ...
        <div class="footer-below-copyright">
            ...
            <div style="display: flex; gap: 5px; flex-direction: column">
                ...
                <a class="link" href="#">How GoFundMe works</a>
