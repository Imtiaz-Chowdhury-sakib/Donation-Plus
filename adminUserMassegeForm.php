...
font-family: 'Kumbh Sans', sans-serif">
    <h1 class="mb-3" style="text-align: center;color: #777676">Messages</h1>
    <!-- Table-->
    ...
    <div class="container-fluid">
        <div class="row">
            <div class=".col-lg-12">
                <h1 class="page-header" style="padding-left: 15px">User Messages</h1>
            </div>
        </div>
