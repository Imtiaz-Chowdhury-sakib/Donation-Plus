    ...
    <div class="ml-auto p2 header-buttons">
        ...
        <div aria-labelledby="dropdownMenuButton" class="dropdown-menu">
            ...
            <a class="dropdown-item" href="../viewProfile.php">
                <div style="display: flex; align-items: center; gap: 5px">
                    <!-- FIXME: ADD SVG IMAGE-->
                    <img alt="navdrop" height="20" src="../res/view-profile.svg" width="20">
                    View Profile
                </div>
            </a>
...
<div class="container container-body" >
        <div style="display: flex; flex-direction: row; gap: 22px">
            <img src="./res/header-login-avatar.svg" style="height: 150px; width: 150px;">

            <div style="display: flex; flex-direction: column; justify-content: center;">
                <div style="display:flex;flex-direction: row; gap: 20px; justify-content: center">
                    <h3 style="text-decoration: none">John Xina</h3>
