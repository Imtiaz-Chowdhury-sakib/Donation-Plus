...
<nav class="navbar navbar-expand-lg sticky-top" id="navbar">
    <li class="nav-item active">
        <a class="nav-link" href="../index.php">
            <div style="display: flex; align-items: center; gap: 5px">
                <img alt="home" height="24" src="../res/navbar-home-button.svg"
    ...
    <button aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"
            ...
            data-target="#navbarSupportedContent" data-toggle="collapse" style="background-color: rgba(255,255,255,0.5)"
            type="button">
        <span style="color: white">
            <svg class="bi bi-three-dots" fill="#FFFFFF" height="16" viewBox="0 0 16 16" width="16"
  ...
  <path d="M3 9.5a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm5 0a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm5 0a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3z"/>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <div class="mr-auto p2">
            <ul class="navbar-nav" style="gap: 0">
                <li class="nav-item dropdown">
                    ...
                    <div aria-labelledby="navbarDropdown" class="dropdown-menu">
                        <a class="dropdown-item" href="medical_index.php" >
                            <input aria-label="category" class="form-control" placeholder="Search By Title" type="hidden" name="category">
                            <div class="dropdown-icon-text">
                                <img alt="home" height="18"
                                     src="../res/navbar-dropdown-menu-medical-button.svg" style="align-content: center"
                                     width="18">
                                Medical
                            </div>
                        </a>
                        <a class="dropdown-item" href="./education_index.php">
                            <div class="dropdown-icon-text">
                        ...
                        <a class="dropdown-item" href="./animal_index.php">
                            <div class="dropdown-icon-text">
                        ...
                        <a class="dropdown-item" href="./others_index.php">
                            <div class="dropdown-icon-text">
                                <img alt="miscIco" height="18" src="../res/navbar-dropdown-menu-misc-button.svg"
                                     width="18">
                                Others
                            </div>
                        </a>
        ...
        <div class="ml-auto p2">
            <form class="form-inline my-2 my-lg-0" method="get" action="../search.php">
                <input aria-label="Search" class="form-control" placeholder="Search By Title" type="search" name="search">
    ...
    <div style="padding: 2rem 7rem 2rem 7rem">
        ...
        <section class="results">
            ...
            if ($textBox_data) {
                ...
                $post = mysqli_query($conn, "SELECT * FROM post where category like '%Education%' and status = 1")
                    ...
                    <div class="card shadow-lg custom-card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                ...
                                <a href="../donateForm_index.php?p_id=<?php echo $result['p_id'];?>">Read More</a>
                            </p>
                            <a class="btn btn-success" href="../signIn.php">Donate</a>
                        </div>
                    </div>
