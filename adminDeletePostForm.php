...
<div style="display:flex; flex-direction: column; margin-left: 270px; padding: 30px; font-family: 'Kumbh Sans', sans-serif">
    <h1 class="mb-3" style="text-align: center;color: #777676">Delete Post</h1>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tr>
                                        ...
                                        <th><img src='res/adminPostDeleteicon.svg' alt ='delete_icon'
                                ...
                                <tr>
                                    ...
                                    <td>" . $row['collecting_amount'] . "</td>
                                    <td><a href='adminDeletePost.php?p_id=" . $row['p_id'] . "' onclick='return onFormSubmission()'><img src='./res/adminPostRemoveicon.svg' alt='' height='22'></a></td>
                                   <script>
