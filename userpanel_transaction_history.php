...
<div style="display:flex; flex-direction: column; margin-left: 20px; margin-right:20px; padding:  2rem;
font-family: 'Kumbh Sans', sans-serif">
    <h1 class="mb-3" style="text-align: center;color: #777676; padding-top: 2rem">Transaction History</h1>
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                $qry = "SELECT u.name,u.email,u.address,p.title,t.d_date,t.d_amount FROM transaction as t JOIN user as u ON u.id = t.u_id JOIN post as p ON t.donate_id=p.p_id WHERE STATUS =1 and p_id=$p_id";
