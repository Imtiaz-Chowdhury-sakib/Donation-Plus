...
font-family: 'Kumbh Sans', sans-serif">
    <h1 class="mb-3" style="text-align: center;color: #777676">Delete User</h1>
    <!-- Table-->
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tr>
                                    ...
                                    <td>" . $row['email'] . "</td>
                                    <td>" . $row['address'] . "</td>
                                     <td><a href='adminUserRemove.php?id=" . $row['id'] . "' onclick='return onFormSubmission()'><img src='./res/adminPostRemoveicon.svg' alt='' height='22'></a></td>
                                     <script>
